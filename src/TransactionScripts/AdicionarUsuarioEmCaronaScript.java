...
public class AdicionarUsuarioEmCaronaScript {
	private int caronaId;
	private String emailUsuario;
	private int paradaId;
	
	public AdicionarUsuarioEmCaronaScript(int caronaId, String emailUsuario, int paradaId) {
	...
	public void execute() throws Exception{
		...
		LogradouroGateway logOrigemGateway = lFinder.find(cGateway.get_logradouroOrigemId());
		...
		LogradouroGateway logDestinoGateway = lFinder.find(cGateway.get_logradouroOrigemId());
		...
		VeiculoGateway vGateway = vFinder.find(cGateway.get_veiculoId());
		...
		v.set_id(cGateway.get_veiculoId());
		...
		for(Parada par : GetParadasByCaronaId(caronaId)){
			carona.AdicionarParada(par);
		}
